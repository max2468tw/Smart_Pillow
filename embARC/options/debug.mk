...
## Set Valid JTAG
VAILD_JTAG = $(call check_item_exist, $(JTAG), $(SUPPORTED_JTAGS))
...
ifeq ($(VAILD_JTAG), opella)
	DBG_HW_FLAGS += -arcv2em -nooptions -nogoifmain -toggle=include_local_symbols=1 -hard \
			-DLL=$(ASH_PATH) \
			-prop=jtag_frequency=8MHz -prop=blast_frequency=6Mhz
else
ifeq ($(VAILD_JTAG), usb)
	DBG_HW_FLAGS += -arcv2em -nooptions -nogoifmain -toggle=include_local_symbols=1 -hard \
			 -digilent $(DIGILENT_PROP) #-on=verify_download -on=spot_verify_download
endif
endif
...
DBG_HW_FLAGS += -nooptions -nogoifmain -toggle=include_local_symbols=1 -on=binary_stdin -on=binary_stdout  \
